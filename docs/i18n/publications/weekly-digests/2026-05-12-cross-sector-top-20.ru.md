# Еженедельный дайджест: Cross-Sector Top 20

Date: 2026-05-12

Status: `draft`

![Тематическое превью межсекторального топ-20](../../../../assets/article-previews/2026-05-12-cross-sector-top-20.svg)

## Назначение

Это первый флагманский межсекторальный рейтинг ABC4RD Academy, построенный на
базе уже опубликованных отраслевых таблиц.
...
| Место | Сущность | Сектор | TSI | OAI | EPI | KAI | CRI | TGI | MI | Итог |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
